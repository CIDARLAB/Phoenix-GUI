...
var STLVisitor = require('./STLVisitor').STLVisitor;
...
SpecificationContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
...
ModuleLeafContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitModuleLeaf(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
ModuleOpContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitModuleOp(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
ModuleDescriptionContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitModuleDescription(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
BooleanPredContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitBooleanPred(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
ParpropContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitParprop(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
STLParser.prototype.property = function(_p) {
    ...
    try {
        ...
        case 5:
            ...
            this.match(STLParser.T__14);
            this.state = 114;
            localctx.child = this.property(8);
            break;
...
STLParser.prototype.expr = function(_p) {
    ...
    try {
        ...
        case STLParser.T__7:
        case STLParser.T__17:
            this.state = 149;
            _la = this._input.LA(1);
            if(!(_la===STLParser.T__7 || _la===STLParser.T__17)) {
...
TranslationMapContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitTranslationMap(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
TranslationPairContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitTranslationPair(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
LimitMapContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitLimitMap(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
LimitPairContext.prototype.accept = function(visitor) {
    if ( visitor instanceof STLVisitor ) {
        return visitor.visitLimitPair(this);
    } else {
        return visitor.visitChildren(this);
    }
};
